    ...
    <div class="card shadow-sm">
        <div class="card-body table-responsive">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h3><i class="bi bi-list-check"></i> Data Karyawan Pendukung Retort</h3>
                <a href="{{ route('operator.create') }}" class="btn btn-success">
            ...
            <table class="table table-striped table-bordered align-middle">
                ...
                <tbody>
                    @php
                    $no = ($operator->currentPage() - 1) * $operator->perPage() + 1;
                    @endphp
                    @forelse ($operator as $dep)
                    <tr>
                        ...
                        <td class="text-center align-middle">
                            ...
                            <form action="{{ route('operator.destroy', $dep->uuid) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
            ...
            <div class="d-flex justify-content-end mt-3">
                {{ $operator->withQueryString()->links('pagination::bootstrap-5') }}
            </div>
        </div>
    </div>
</div>
