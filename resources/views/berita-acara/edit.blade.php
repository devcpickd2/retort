...
<div class="container py-4">
    <div class="card shadow-sm border-0">
        <div class="card-body p-4 p-md-5">
            ...
            {{-- Header --}}
            <h4 class="mb-1"><i class="bi bi-pencil-square"></i> Edit Berita Acara: {{ $beritaAcara->nomor }}</h4>
            <p class="text-muted mb-4">Perbarui detail formulir berita acara di bawah ini.</p>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nomor" id="nomor" class="form-control" 
                                           value="{{ old('nomor', $beritaAcara->nomor) }}" required>
                                </div>
                                <div class="mb-3">
                                    <label for="nama_barang" class="form-label">Nama Barang <span class="text-danger">*</span></label>
                                    <input type="text" name="nama_barang" id="nama_barang" class="form-control"
                                           value="{{ old('nama_barang', $beritaAcara->nama_barang) }}" required>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="jumlah_barang" id="jumlah_barang" class="form-control"
                                           ...
                                           value="{{ old('jumlah_barang', $beritaAcara->jumlah_barang) }}" required>
                                </div>
                                <div class="mb-3">
                                    <label for="supplier" class="form-label">Supplier <span class="text-danger">*</span></label>
                                    <input type="text" name="supplier" id="supplier" class="form-control"
                                           value="{{ old('supplier', $beritaAcara->supplier) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="tanggal_kedatangan" id="tanggal_kedatangan" class="form-control"
                                           value="{{ old('tanggal_kedatangan', $beritaAcara->tanggal_kedatangan->format('Y-m-d')) }}" required>
                                </div>
                                <div class="mb-3">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <textarea name="uraian_masalah" id="uraian_masalah" class="form-control" rows="4" required>{{ old('uraian_masalah', $beritaAcara->uraian_masalah) }}</textarea>
                        </div>
                        
                        <hr class="my-4">

                        <label class="form-label">Keputusan</label>
                        {{-- Helper untuk check `old()` dulu, baru data dari database --}}
                        @php
                            $cek = fn($field) => old($field, $beritaAcara->{$field}) ? 'checked' : '';
                        @endphp
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="keputusan_pengembalian" id="cb1" {{ $cek('keputusan_pengembalian') }}>
                                    <label class="form-check-label" for="cb1">Pengembalian Barang</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="keputusan_potongan_harga" id="cb2" {{ $cek('keputusan_potongan_harga') }}>
                                    <label class="form-check-label" for="cb2">Potongan Harga</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="keputusan_sortir" id="cb3" {{ $cek('keputusan_sortir') }}>
                                    <label class="form-check-label" for="cb3">Sortir</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="keputusan_penukaran_barang" id="cb4" {{ $cek('keputusan_penukaran_barang') }}>
                                    <label class="form-check-label" for="cb4">Penukaran Barang</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="keputusan_penggantian_biaya" id="cb5" {{ $cek('keputusan_penggantian_biaya') }}>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <textarea name="analisa_penyebab" id="analisa_penyebab" class="form-control" rows="3">{{ old('analisa_penyebab', $beritaAcara->analisa_penyebab) }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label for="tindak_lanjut_perbaikan" class="form-label">B. Tindak Lanjut Perbaikan dan Pencegahan</label>
                            <textarea name="tindak_lanjut_perbaikan" id="tindak_lanjut_perbaikan" class="form-control" rows="3">{{ old('tindak_lanjut_perbaikan', $beritaAcara->tindak_lanjut_perbaikan) }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <textarea name="lampiran" id="lampiran" class="form-control" rows="3">{{ old('lampiran', $beritaAcara->lampiran) }}</textarea>
                        </div>
                    </div>
                </div>
