{{-- resources/views/raw_material/verification.blade.php --}}

@extends('layouts.app')

@push('styles')
    {{-- Menggunakan style yang sama dari contoh MagnetTrap Anda --}}
    ...
    <div class="card shadow-sm">
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                {{-- JUDUL DIUBAH --}}
                <h3 class="card-title mb-0 fw-bold"><i class="bi bi-shield-check me-2"></i>Verifikasi Pemeriksaan Bahan Baku</h3>
            </div>

            {{-- FORM FILTER DIARAHKAN KE ROUTE BARU --}}
            <form method="GET" action="{{ route('inspections.verification') }}" class="row g-3 mb-4">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    {{-- PLACEHOLDER DIUBAH --}}
                    <input type="text" name="search" class="form-control" placeholder="Cari Bahan Baku/Supplier..." value="{{ request('search') }}">
                </div>
                <div class="col-md-3 d-flex gap-2">
                    ...
                    {{-- LINK RESET DIUBAH --}}
                    <a href="{{ route('inspections.verification') }}" class="btn btn-secondary w-100">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="status_spv" id="status_spv_{{ $item->uuid }}" class="form-select form-select-lg fw-bold text-center mx-auto form-select-custom" style="width: 85%;" required>
                             {{-- Logika 'old()' akan menangani jika validasi gagal --}}
