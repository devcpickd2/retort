...
<div class="container py-4">
    <div class="card shadow-sm border-0">
        <div class="card-body p-4 p-md-5">
            ...
            {{-- Header Baru --}}
            <h4 class="mb-1"><i class="bi bi-pencil-square"></i> Edit Disposisi: {{ $disposition->nomor }}</h4>
            <p class="text-muted mb-4">Perbarui detail formulir disposisi di bawah ini.</p>
