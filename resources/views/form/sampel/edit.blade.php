...
<div class="container-fluid py-4">
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <form id="editForm" action="{{ route('sampel.edit_spv', $sampel->uuid) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                class="form-control" 
                                value="{{ old('date', $sampel->date) }}" required>
                            </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                value="{{ old('kode_produksi', $sampel->kode_produksi) }}" required>
