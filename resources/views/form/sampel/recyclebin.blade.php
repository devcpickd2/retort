...
<div class="container-fluid py-4">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h3><i class="bi bi-trash"></i> Recycle Bin Pengambilan Sampel</h3>
                <a href="{{ route('sampel.index') }}" class="btn btn-primary">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <form action="{{ route('sampel.restore', $item->uuid) }}" method="POST" class="d-inline">
                                    @csrf
                                ...
                                <form action="{{ route('sampel.deletePermanent', $item->uuid) }}" 
    ...
    <div class="d-flex justify-content-end mt-2">
        {{ $sampel->links('pagination::bootstrap-5') }}
    </div>
</div>
</div>
