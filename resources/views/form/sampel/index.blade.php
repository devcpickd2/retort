...
<div class="container-fluid py-0">
    ...
    <div class="d-sm-flex justify-content-between align-items-center mb-4">
        <h2 class="h4">Pengambilan Sampel</h2>
        <div class="btn-group" role="group">
            @can('can access add button')
            <a href="{{ route('sampel.create') }}" class="btn btn-success">
    ...
    <form id="filterForm" method="GET" action="{{ route('sampel.index') }}" class="d-flex flex-wrap align-items-center gap-2 mb-3 p-3 border rounded bg-white shadow-sm">
        <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-4 align-self-end">
                <a href="{{ route('sampel.index') }}" class="btn btn-primary mb-2">
