...
<div class="container-fluid py-0">
    ...
    <div class="d-sm-flex justify-content-between align-items-center mb-4">
        <h2 class="h4">Kontrol Sanitasi</h2>
        <div class="btn-group" role="group">
            ...
            <a href="{{ route('sanitasi.exportPdf', ['date' => request('date'), 'shift' => request('shift')]) }}"
                target="_blank" class="btn btn-danger">
                <i class="bi bi-file-earmark-pdf"></i> Export PDF
            </a>
            @endcan
            @can('can access recycle')
            <a href="{{ route('sanitasi.recyclebin') }}" class="btn btn-secondary">
    ...
    <form id="filterForm" method="GET" action="{{ route('sanitasi.index') }}"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center align-middle">
                            ...
                            data-bs-target="#pemeriksaanModal{{ $dep->uuid }}">
                            Lihat Pemeriksaan
                        </a>
