                    ...
                    <tbody>
                        ...
                        <tr>
                                    ...
                                    <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                @if($dep->catatan)
                                                <h6 class="text-start text-primary fw-bold mt-2"><i
                                                        class="bi bi-journal-text me-1"></i> Catatan</h6>
                            ...
                            <td class="text-center align-middle">
                                ...
                                <a href="{{ route('washing.edit.form', $dep->uuid) }}"
                                    class="btn btn-warning btn-sm me-1">
                                    <i class="bi bi-pencil-square"></i> Edit
                                </a>
                                @endcan
                                @can('can access update button')
                                <a href="{{ route('washing.update.form', $dep->uuid) }}"
                                    class="btn btn-info btn-sm me-1">
                                    <i class="bi bi-pencil"></i> Update
                                </a>
                                @endcan
                                @can('can access delete button')
                                <form action="{{ route('washing.destroy', $dep->uuid) }}" method="POST"
                                    class="d-inline">
                                    @csrf
                                    @method('DELETE')
                                ...
                                <div class="modal fade" id="verifyModal{{ $dep->uuid }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-md">
                                        <form action="{{ route('washing.verification.update', $dep->uuid) }}"
                                            method="POST">
                                            @csrf
                                            @method('PUT')
