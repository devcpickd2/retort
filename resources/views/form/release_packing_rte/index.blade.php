            ...
            <div class="table-responsive">
             <table class="table table-striped table-bordered align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center align-middle">
                         ...
                         <td class="text-center">
                             <a href="{{ route('release_packing_rte.update.form', $dep->uuid) }}" class="btn btn-warning btn-sm me-1">
                    ...
                    @empty
                    <tr>
                        <td colspan="12" class="text-center">Belum ada data Release packing rte.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
