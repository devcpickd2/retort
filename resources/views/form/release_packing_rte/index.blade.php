...
<div class="container-fluid py-0">
    ...
    <div class="d-sm-flex justify-content-between align-items-center mb-4">
        ...
        <div class="btn-group" role="group">
            ...
            <a href="{{ route('release_packing_rte.recyclebin') }}" class="btn btn-secondary">
    ...
    <form id="filterForm" method="GET" action="{{ route('release_packing_rte.index') }}"
    ...
    <div class="row">
        ...
        <div class="col-md-4 align-self-end">
            <a href="{{ route('release_packing_rte.index') }}" class="btn btn-primary mb-2">
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (exportBtn) {
            exportBtn.addEventListener('click', () => {
                ...
                const exportUrl = "{{ route('release_packing_rte.exportPdf') }}?" + new URLSearchParams(
                    formData).toString();
            ...
            <table class="table align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header bg-danger text-white">
                                            <h5 class="modal-title" id="revisionModalLabel{{ $dep->uuid }}">Detail Revisi
                                            </h5>
                        ...
                        <a href="{{ route('release_packing_rte.edit.form', $dep->uuid) }}"
                            class="btn btn-warning btn-sm me-1">
                            <i class="bi bi-pencil-square"></i> Edit
                        </a>
                        @endcan
                        @can('can access update button')
                        <a href="{{ route('release_packing_rte.update.form', $dep->uuid) }}"
                            class="btn btn-info btn-sm me-1">
                            <i class="bi bi-pencil"></i> Update
                        </a>
                        @endcan
                        @can('can access delete button')
                        <form action="{{ route('release_packing_rte.destroy', $dep->uuid) }}" method="POST"
                            class="d-inline">
                            @csrf
                            @method('DELETE')
                    ...
                    <div class="modal fade" id="verifyModal{{ $dep->uuid }}" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-md">
                            <form action="{{ route('release_packing_rte.verification.update', $dep->uuid) }}"
                                method="POST">
                                @csrf
                                @method('PUT')
                        ...
                        <div class="modal-body p-5">
                            <p class="text-light mb-4 fs-6">
                                Pastikan data yang akan diverifikasi di check dengan teliti terlebih
                                dahulu.
                            </p>
                            <div class="row g-4">
                                <div class="col-md-12">
                                    ...
                                    <select name="status_spv" id="status_spv_{{ $dep->uuid }}"
                                        ...
                                        <option value="2" {{ $dep->status_spv == 2 ? 'selected' : '' }}
                                            style="color: #dc3545; font-weight: 600;">❌ Revision (Perlu
                                        Perbaikan)</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-12 mt-3">
                                    ...
                                    <textarea name="catatan_spv" id="catatan_spv_{{ $dep->uuid }}"
                                        rows="4" class="form-control text-dark border-0 shadow-none"
...
@empty
<tr>
    <td colspan="19" class="text-center">Belum ada data release packing rte.</td>
</tr>
@endforelse
</tbody>
</table>
