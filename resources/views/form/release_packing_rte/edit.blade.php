...
<div class="container-fluid py-4">
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <form id="releasepackingForm" action="{{ route('release_packing_rte.edit_spv', $release_packing_rte->uuid) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                value="{{ old('date', $release_packing_rte->date) }}" required>
                            </div>
                            <div class="col-md-6">
