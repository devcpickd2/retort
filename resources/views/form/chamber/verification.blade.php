...
<div class="container-fluid py-0">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <form id="filterForm" method="GET" action="{{ route('chamber.verification') }}" class="d-flex flex-wrap align-items-center gap-2 mb-3 p-2 border rounded bg-light shadow-sm">
                ...
                <table class="table table-striped table-bordered align-middle">
                    ...
                    <tbody>
                        ...
                        <td class="text-center align-middle">
                            ...
                            <a href="{{ route('chamber.edit.form', $dep->uuid) }}" class="btn btn-warning btn-sm me-1">
