    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h3><i class="bi bi-trash"></i> Recycle Bin Peneraan Timbangan</h3>
                <a href="{{ route('timbangan.index') }}" class="btn btn-primary">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover align-middle mb-0">
                    ...
                    <tbody>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <table class="table table-bordered table-sm text-center align-middle mb-0" style="font-size: 12px;">
                                                ...
                                                <tbody>
                                                    @foreach($peneraan as $items)
                                                    <tr>
                                                        <td>{{ $items['kode_timbangan'] ?? '-' }}</td>
                                                        <td>{{ $items['standar'] ?? '-' }}</td>
                                                        <td>{{ $items['pukul'] ?? '-' }}</td>
                        ...
                        <td class="text-center align-middle">
                            <form action="{{ route('timbangan.restore', $item->uuid) }}" method="POST" class="d-inline">
                                @csrf
                            ...
                            <form action="{{ route('timbangan.deletePermanent', $item->uuid) }}" 
