...
<div class="container-fluid py-0">
	...
	<div class="card shadow-sm">
		<div class="card-body">
			...
			<form id="filterForm" method="GET" action="{{ route('sampling.verification') }}" class="d-flex flex-wrap align-items-center gap-2 mb-3 p-2 border rounded bg-light shadow-sm">
			...
			<div class="table-responsive">
				<table class="table table-striped table-bordered align-middle">
					...
					<tbody>
						...
						<td class="text-center align-middle">
							...
							<td class="text-center align-middle">
								...
								<a href="{{ route('sampling.edit.form', $dep->uuid) }}" class="btn btn-warning btn-sm me-1">
					...
					@empty
					<tr>
						<td colspan="19" class="text-center">Belum ada data sampling.</td>
					</tr>
					@endforelse
				</tbody>
			</table>
