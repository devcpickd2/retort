...
<div class="container-fluid py-0">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <form id="filterForm" method="GET" action="{{ route('packing.verification') }}" class="d-flex flex-wrap align-items-center gap-2 mb-3 p-2 border rounded bg-light shadow-sm">
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                ...
                                <td class="text-center align-middle">
                                    ...
                                    <a href="{{ route('packing.edit.form', $dep->uuid) }}" class="btn btn-warning btn-sm me-1">
