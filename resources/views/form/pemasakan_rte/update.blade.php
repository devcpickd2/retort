...
<div class="container-fluid py-4">
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <form id="pvdcForm" action="{{ route('pemasakan_rte.update_qc', $pemasakan_rte->uuid) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                value="{{ old('date', $pemasakan_rte->date) }}" 
                                {{ $pemasakan_rte->date ? 'readonly' : '' }}>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Shift</label>
                                <select class="form-control" disabled>
                                    @foreach([1,2,3] as $s)
                                    <option value="{{ $s }}" {{ old('shift', $pemasakan_rte->shift) == $s ? 'selected' : '' }}>Shift {{ $s }}</option>
                                    @endforeach
                                </select>
                                <input type="hidden" name="shift" value="{{ $pemasakan_rte->shift }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="hidden" name="nama_produk" value="{{ $pemasakan_rte->nama_produk }}">
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="hidden" name="no_chamber" value="{{ $pemasakan_rte->no_chamber }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                {{ $pemasakan_rte->suhu_produk ? 'readonly' : '' }}>
                            </div>
                            <div class="col-md-6">
                                ...
                                {{ $pemasakan_rte->jumlah_tray ? 'readonly' : '' }}>
                            </div>
                        </div>
                    </div>
                </div>

                @php $cooking = json_decode($pemasakan_rte->cooking, true); @endphp
                        ...
                        <table class="table table-bordered text-center">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" step="0.01" name="cooking[suhu_air_sterilisasi][]" 
                                        value="{{ $cooking['suhu_air_sterilisasi'][$i] ?? '' }}" 
                                        class="form-control form-control-sm text-center"
                                        {{ isset($cooking['suhu_air_sterilisasi'][$i]) ? 'readonly' : '' }}>
                                    </td>
                                    @endforeach
                                </tr>
                                <tr>
                                    ...
                                    @foreach(range(0,3) as $i)
                                    <td>
                                        <input type="number" step="0.01" name="cooking[thermometer_retort][]" 
                                        value="{{ $cooking['thermometer_retort'][$i] ?? '' }}" 
                                        class="form-control form-control-sm text-center"
                                        {{ isset($cooking['thermometer_retort'][$i]) ? 'readonly' : '' }}>
                                    </td>
                                    @endforeach
                                </tr>
                                <tr>
                                    ...
                                    @foreach(range(0,3) as $i)
                                    <td>
                                        <input type="number" step="0.01" name="cooking[tekanan_sterilisasi][]" 
                                        value="{{ $cooking['tekanan_sterilisasi'][$i] ?? '' }}" 
                                        class="form-control form-control-sm text-center"
                                        {{ isset($cooking['tekanan_sterilisasi'][$i]) ? 'readonly' : '' }}>
                                    </td>
                                    @endforeach
                                </tr>
                                <tr>
