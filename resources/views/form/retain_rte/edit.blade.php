...
<div class="container-fluid py-4">
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <form id="retainForm" method="POST" action="{{ route('retain_rte.edit_spv', $retain_rte->uuid) }}">
                @csrf
                @method('PUT')
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                value="{{ old('date', $retain_rte->date) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select id="nama_produk" name="nama_produk" class="form-control selectpicker" data-live-search="true" title="Ketik nama produk..." required>
                                    ...
                                    <option value="{{ $produk->nama_produk }}"
                                        {{ old('nama_produk', $retain_rte->nama_produk) == $produk->nama_produk ? 'selected' : '' }}>
                                        {{ $produk->nama_produk }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                maxlength="10" value="{{ old('kode_produksi', $retain_rte->kode_produksi) }}" required>
                                ...
                                <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        ...
                                        class="form-control form-control-sm rata_score" step="0.1" readonly
...
{{-- Script hitung rata-rata & hasil release --}}
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        hitungRataDanRelease(); // hitung ulang saat load
    });
    });
</script>
