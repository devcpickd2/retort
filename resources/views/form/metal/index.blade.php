            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered align-middle">
                    ...
                    <tbody>
                        ...
                        <!-- Modal ENGINEER -->
                        <div class="modal fade" id="checkedModalEngineer{{ $dep->uuid }}" tabindex="-1" aria-labelledby="checkedModalEngineerLabel{{ $dep->uuid }}" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header bg-success text-white">
                                        <h5 class="modal-title" id="checkedModalEngineerLabel{{ $dep->uuid }}">Detail Checked</h5>
                                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <ul class="list-unstyled mb-0">
                                            <li><strong>Status:</strong> Checked</li>
                                            <li><strong>Nama Engineer:</strong> {{ $dep->nama_engineer ?? '-' }}</li>
                                        </ul>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Tutup</button>
                    ...
                    <td class="text-center align-middle">
                        ...
                        @endif
                            ...
                            <td class="text-center align-middle">
                                ...
                                <a href="{{ route('metal.edit.form', $dep->uuid) }}" class="btn btn-warning btn-sm me-1">
                                    <i class="bi bi-pencil-square"></i> Edit
                                </a>
                                @endcan
                                @can('can access update button')
                                <a href="{{ route('metal.update.form', $dep->uuid) }}" class="btn btn-info btn-sm me-1">
