                            ...
                            <table class="table table-bordered align-middle text-center">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="conveyor" id="conveyor" class="form-control form-control-sm text-center">
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <table class="table table-bordered align-middle text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" name="kondisi_produk[basah_air_total]" id="basah_air_total" class="form-control form-control-sm text-center" readonly></td>
                                        <td><input type="number" name="kondisi_produk[kering_air_total]" id="kering_air_total" class="form-control form-control-sm text-center" readonly></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered align-middle text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-start">Total</td>
                                        <td><input type="number" name="kondisi_produk[basah_minyak_total]" id="basah_minyak_total" class="form-control form-control-sm text-center" readonly></td>
                                        <td><input type="number" name="kondisi_produk[kering_minyak_total]" id="kering_minyak_total" class="form-control form-control-sm text-center" readonly></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
