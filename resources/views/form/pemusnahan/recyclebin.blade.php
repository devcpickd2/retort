    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h3><i class="bi bi-trash"></i> Recycle Bin Pemusnahan Produk / Barang</h3>
                <a href="{{ route('pemusnahan.index') }}" class="btn btn-primary">
                ...
                <table class="table table-striped table-bordered table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">{{ $item->analisa }}</td>
