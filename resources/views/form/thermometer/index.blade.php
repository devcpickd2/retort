        ...
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    ...
                    <a href="{{ route('thermometer.create') }}" class="btn btn-success me-2">
                        <i class="bi bi-plus-circle"></i> Tambah
                    </a>
                    @endcan
                    <a href="{{ route('thermometer.exportPdf', ['date' => request('date'), 'shift' => request('shift')]) }}" target="_blank" class="btn btn-primary">
