...
<div class="container-fluid py-4">
    <div class="card shadow-sm">
        <div class="card-body">
            <h4 class="mb-4">
                <i class="bi bi-plus-circle"></i> Form Input Peneraan Thermometer
            </h4>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-sm text-center align-middle" id="pemeriksaanTable">
                                ...
                                <tbody id="peneraanTable">
                                    <tr>
                                        <td><input type="text" name="peneraan[0][kode_thermometer]" class="form-control form-control-sm a peneraan" required></td>
                                        <td><input type="text" name="peneraan[0][area]" class="form-control form-control-sm a peneraan" required></td>
                                        <td><input type="number" name="peneraan[0][standar]" class="form-control form-control-sm peneraan" step="0.1" value="0.0" required></td>
