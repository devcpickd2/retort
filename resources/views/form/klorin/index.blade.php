    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h3><i class="bi bi-list-check"></i> Pengecekan Klorin</h3>
                <div>
                    @can('can access add button')
                    <a href="{{ route('klorin.create') }}" class="btn btn-success me-2">
                        <i class="bi bi-plus-circle"></i> Tambah
                    </a>
                    @endcan
                    <a href="{{ route('klorin.exportPdf', ['date' => request('date')]) }}" target="_blank" class="btn btn-primary">
            ...
            <form id="filterForm" method="GET" action="{{ route('klorin.index') }}" class="d-flex flex-wrap align-items-center gap-2 mb-3 p-2 border rounded bg-light shadow-sm">
