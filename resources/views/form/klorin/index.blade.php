...
<div class="container-fluid py-0">
    ...
    <div class="d-sm-flex justify-content-between align-items-center mb-4">
        <h2 class="h4">Pengecekan Klorin</h2>
        <div class="btn-group" role="group">
            @can('can access add button')
            <a href="{{ route('klorin.create') }}" class="btn btn-success">
                <i class="bi bi-plus-circle"></i> Tambah
            </a>
            @endcan
            @can('can access export')
            <a href="{{ route('klorin.exportPdf', ['date' => request('date')]) }}" target="_blank" class="btn btn-danger">
                <i class="bi bi-file-earmark-pdf"></i> Export PDF
            </a>
            @endcan
            @can('can access recycle')
            <a href="{{ route('klorin.recyclebin') }}" class="btn btn-secondary">
    ...
    <form id="filterForm" method="GET" action="{{ route('klorin.index') }}" class="d-flex flex-wrap align-items-center gap-2 mb-3 p-3 border rounded bg-white shadow-sm">
        <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-4 align-self-end">
                <a href="{{ route('klorin.index') }}" class="btn btn-primary mb-2">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <div class="modal fade" id="checkedModalProduksi{{ $dep->uuid }}" tabindex="-1" aria-labelledby="checkedModalProduksiLabel{{ $dep->uuid }}" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header bg-success text-white">
                                            <h5 class="modal-title" id="checkedModalProduksiLabel{{ $dep->uuid }}">Detail Checked</h5>
                        ...
                        <td class="text-center align-middle">
                            ...
                            <a href="{{ route('klorin.edit.form', $dep->uuid) }}" class="btn btn-warning btn-sm me-1 mb-1">
                                <i class="bi bi-pencil-square"></i> Edit Data
                            </a>
                            @endcan
                            @can('can access update button')
                            <a href="{{ route('klorin.update.form', $dep->uuid) }}" class="btn btn-info btn-sm me-1 mb-1">
                                <i class="bi bi-pencil"></i> Update
                            </a>
                            @endcan
                            @can('can access delete button')
                            <form action="{{ route('klorin.destroy', $dep->uuid) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
