                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                value="{{ old('date', $stuffing->date) }}" 
                                {{ $stuffing->date ? 'readonly' : '' }} required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                maxlength="10" value="{{ old('kode_produksi', $stuffing->kode_produksi) }}" 
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                value="{{ old('exp_date', $stuffing->exp_date) }}" 
                                {{ $stuffing->exp_date ? 'readonly' : '' }}>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="time" id="jamMulaiInput" name="jam_mulai" class="form-control @error('jam_mulai') is-invalid @enderror" value="{{ old('jam_mulai', $stuffing->jam_mulai) }}" {{ $stuffing->jam_mulai ? 'readonly' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" name="suhu" class="form-control @error('suhu') is-invalid @enderror" value="{{ old('suhu', $stuffing->suhu) }}" {{ $stuffing->suhu ? 'readonly' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            @if(in_array($field,['cek_vakum','kebersihan_seal','kekuatan_seal','print_kode']))
                                ...
                                <select name="{{ $field }}" class="form-control @error($field) is-invalid @enderror">
                                    <option value="">-- Pilih --</option>
                                    <option value="OK" {{ old($field, $stuffing->$field)=='OK' ? 'selected' : '' }}>OK</option>
                                    <option value="Tidak OK" {{ old($field, $stuffing->$field)=='Tidak OK' ? 'selected' : '' }}>Tidak OK</option>
                                </select>
                                @endif
                            @else
                                <input type="number" step="0.01" name="{{ $field }}" class="form-control @error($field) is-invalid @enderror" value="{{ old($field, $stuffing->$field) }}" {{ $stuffing->$field ? 'readonly' : '' }}>
                            @endif
