                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="date" name="date" id="dateInput" class="form-control @error('date') is-invalid @enderror" value="{{ old('date') }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="kode_produksi" id="kode_produksi" class="form-control @error('kode_produksi') is-invalid @enderror" maxlength="10" value="{{ old('kode_produksi') }}" required>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <select name="kode_mesin" class="form-control @error('kode_mesin') is-invalid @enderror" required>
                                ...
                                @foreach($mesins as $m)
                                <option value="{{ $m->nama_mesin }}" {{ old('kode_mesin') == $m->nama_mesin ? 'selected' : '' }}>
                                    {{ $m->nama_mesin }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="time" id="jamMulaiInput" name="jam_mulai" class="form-control @error('jam_mulai') is-invalid @enderror" value="{{ old('jam_mulai') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" name="suhu" class="form-control @error('suhu') is-invalid @enderror" value="{{ old('suhu') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="sensori" class="form-control @error('sensori') is-invalid @enderror">
                                ...
                                <option value="Tidak OK" {{ old('sensori')=='Tidak OK' ? 'selected' : '' }}>Tidak OK</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" name="kecepatan_stuffing" class="form-control @error('kecepatan_stuffing') is-invalid @enderror" value="{{ old('kecepatan_stuffing') }}">
                            <small class="text-danger">@error('kecepatan_stuffing') {{ $message }} @enderror</small>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Panjang per pcs (cm)</label>
                            <input type="number" step="0.01" name="panjang_pcs" class="form-control @error('panjang_pcs') is-invalid @enderror" value="{{ old('panjang_pcs') }}">
                            <small class="text-danger">@error('panjang_pcs') {{ $message }} @enderror</small>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Berat per pcs (gr)</label>
                            <input type="number" step="0.01" name="berat_pcs" class="form-control @error('berat_pcs') is-invalid @enderror" value="{{ old('berat_pcs') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="cek_vakum" class="form-control @error('cek_vakum') is-invalid @enderror">
                                ...
                                <option value="Tidak OK" {{ old('cek_vakum')=='Tidak OK' ? 'selected' : '' }}>Tidak OK</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="kebersihan_seal" class="form-control @error('kebersihan_seal') is-invalid @enderror">
                                <option value="">-- Pilih --</option>
                                <option value="OK" {{ old('kebersihan_seal')=='OK' ? 'selected' : '' }}>OK</option>
                                <option value="Tidak OK" {{ old('kebersihan_seal')=='Tidak OK' ? 'selected' : '' }}>Tidak OK</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="kekuatan_seal" class="form-control @error('kekuatan_seal') is-invalid @enderror">
                                <option value="">-- Pilih --</option>
                                <option value="OK" {{ old('kekuatan_seal')=='OK' ? 'selected' : '' }}>OK</option>
                                <option value="Tidak OK" {{ old('kekuatan_seal')=='Tidak OK' ? 'selected' : '' }}>Tidak OK</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" name="diameter_klip" class="form-control @error('diameter_klip') is-invalid @enderror" value="{{ old('diameter_klip') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="print_kode" class="form-control @error('print_kode') is-invalid @enderror">
                                ...
                                <option value="Tidak OK" {{ old('print_kode')=='Tidak OK' ? 'selected' : '' }}>Tidak OK</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" name="lebar_cassing" class="form-control @error('lebar_cassing') is-invalid @enderror" value="{{ old('lebar_cassing') }}">
