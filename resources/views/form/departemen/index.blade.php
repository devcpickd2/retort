        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered align-middle">
                    ...
                    <tbody>
                        @php
                        $no = ($departemens instanceof \Illuminate\Pagination\LengthAwarePaginator)
                        ? ($departemens->currentPage() - 1) * $departemens->perPage() + 1
                        : 1;
                        @endphp
            ...
            {{-- Pagination --}}
            @if($departemens instanceof \Illuminate\Pagination\LengthAwarePaginator)
            <div class="mt-3 d-flex justify-content-end">
                {{ $departemens->withQueryString()->links('pagination::bootstrap-5') }}
            </div>
            @endif
        </div>
    </div>
