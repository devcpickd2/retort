                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                ...
                                <a href="{{ route('karton.edit.form', $dep->uuid) }}" class="btn btn-warning btn-sm me-1 mb-1">
                                    <i class="bi bi-pencil-square"></i> Edit Data
                                </a>
                                @endcan
                                @can('can access update button')
                                <a href="{{ route('karton.update.form', $dep->uuid) }}" class="btn btn-info btn-sm me-1 mb-1">
