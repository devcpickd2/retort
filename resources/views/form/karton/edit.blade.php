...
<div class="container-fluid py-4">
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <form id="samplingForm" action="{{ route('karton.edit_spv', $karton->uuid) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="nama_supplier" name="nama_supplier" class="form-control selectpicker" data-live-search="true" required>
                                    ...
                                    <option value="{{ $supplier->nama_supplier }}" {{ old('nama_supplier', $karton->nama_supplier) == $supplier->nama_supplier ? 'selected' : '' }}>
