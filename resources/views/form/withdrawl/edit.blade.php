...
<div class="container-fluid py-4">
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <h4 class="mb-4">
                <i class="bi bi-pencil-square"></i> Edit Laporan Withdrawl
            </h4>

            <form id="withdrawlForm" method="POST" action="{{ route('withdrawl.update', $withdrawl->uuid) }}">
                @csrf
                @method('PUT')
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3">
                                ...
                                class="form-control"
                                value="{{ old('date', $withdrawl->date) }}" required>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                class="form-control"
                                value="{{ old('no_withdrawl', $withdrawl->no_withdrawl) }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                ...
                                <option value="{{ $produk->nama_produk }}"
                                    {{ $withdrawl->nama_produk == $produk->nama_produk ? 'selected' : '' }}>
                                    {{ $produk->nama_produk }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            value="{{ old('kode_produksi', $withdrawl->kode_produksi) }}" required>
                        ...
                        <div class="col-md-3">
                            ...
                            class="form-control"
                            value="{{ old('exp_date', $withdrawl->exp_date) }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            class="form-control"
                            value="{{ old('jumlah_produksi', $withdrawl->jumlah_produksi) }}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            class="form-control"
                            value="{{ old('tanggal_edar', $withdrawl->tanggal_edar) }}">
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            class="form-control"
                            value="{{ old('jumlah_edar', $withdrawl->jumlah_edar) }}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            class="form-control"
                            value="{{ old('tanggal_tarik', $withdrawl->tanggal_tarik) }}">
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            class="form-control"
                            value="{{ old('jumlah_tarik', $withdrawl->jumlah_tarik) }}">
                        </div>
                    </div>
                ...
                <div class="card-body table-responsive">
                    <table class="table table-bordered text-center align-middle">
                        ...
                        <tbody id="rincianBody">
                            ...
                            @foreach($withdrawlData as $i => $row)
                            <tr>
                                <td>
                                    <select name="rincian[{{ $i }}][nama_supplier]"
                                    ...
                                    <option value="{{ $sup->nama_supplier }}"
                                        ...
                                        {{ ($row['nama_supplier'] ?? '') == $sup->nama_supplier ? 'selected' : '' }}>
                                        {{ $sup->nama_supplier }}
                                    </option>
                                    @endforeach
...
// ================== TAMBAH RINCIAN ==================
    let rowIndex = {{ count($withdrawlData ?? []) }};
        ...
        <tr>
            ...
            <td>
                <input type="text" name="rincian[${rowIndex}][alamat]"
                    id="alamat_${rowIndex}" class="form-control form-control-sm">
            </td>
