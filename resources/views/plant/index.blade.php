        ...
        <table class="table table-striped table-bordered align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="align-middle">{{ $dep->plant }}</td>
                    <td class="text-center align-middle">
                        <a href="{{ route('plant.edit', $dep->uuid) }}" class="btn btn-warning btn-sm me-1" title="Edit">
                ...
                @empty
                <tr>
                    <td colspan="4" class="text-center">Belum ada data plant.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
