    ...
    <div class="card shadow-sm">
        <div class="card-body table-responsive">
         ...
         <div class="d-flex justify-content-between align-items-center mb-4">
            <h3><i class="bi bi-list-check"></i> Data Supplier Packaging & Raw Material Retort</h3>
        ...
        <table class="table table-striped table-bordered align-middle">
            ...
            <tbody>
                @php
                $no = ($supplier->currentPage() - 1) * $supplier->perPage() + 1;
                @endphp
                @forelse ($supplier as $dep)
                <tr>
                    ...
                    <td class="text-center align-middle">
                        ...
                        <form action="{{ route('supplier.destroy', $dep->uuid) }}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
